...
class DataArguments:
    ...
    data_json_file: Optional[str] = field(
        default=None,
        metadata={"help": "Path to the JSON file containing the dataset."},
    )
    fix_number_of_image_tokens: Optional[int] = field(
        default=None,
        metadata={"help": "Fix the number of image tokens in the input."},
    )
    use_past_visual_embeds: bool = field(
        default=False,
        metadata={"help": "Whether use past visual embeddings or not. Do not specify it."},
    )
    ...
    cache_file_name: Optional[str] = field(
        default=None,
        metadata={"help": "Name of the cache file to use for storing the tokenized datasets."},
    )
