...
class FreezeArguments:
    ...
    unfreeze_last_n_vision_tower_layers: Optional[int] = field(
        default=None,
        metadata={
            "help": (
                "The number of trainable layers for vision tower in freeze (partial-parameter) fine-tuning. "
                "Positive numbers mean the last n layers are set as trainable, "
                "negative numbers mean the first n layers are set as trainable."
            )
        },
...
class FinetuningArguments(FreezeArguments, LoraArguments, RLHFArguments, GaloreArguments, BAdamArgument):
    ...
    pkd_fixed_depth_reduction: Optional[int] = field(
        default=None,
        metadata={"help": "Fixed depth reduction for the model."},
    )
    pkd_start_reduction: Optional[float] = field(
        default=None,
        metadata={"help": "Start reduction for the model. Between 0 and 1."},
    )
    pkd_end_reduction: Optional[float] = field(
        default=None,
        metadata={"help": "End reduction for the model. Between 0 and 1."},
    )
    pkd_end_distillation_percentage: Optional[float] = field(
        default=None,
        metadata={"help": "End distillation percentage for the model. Between 0 and 1."},
    )
